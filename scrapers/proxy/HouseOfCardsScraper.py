...
class HouseOfCardsScraper(Scraper):
    ...
    def scrape(self):
        # https://app.scrapingbee.com/api/v1/?api_key=${}&url=${}
        encodedUrl = urllib.parse.quote(self.url, safe='/')
        url = f'https://app.scrapingbee.com/api/v1/?api_key={API_KEY}&url={encodedUrl}'
